...
public class Tor_server implements Event_Interface
{
	...
	public String cancelEvent1(String eventID, String eventType)
	{
		...
		public String swapEvent(String customerID, String newEventID, String newEventType, String oldEventID, String oldEventType){
			...
			if(msg2.equalsIgnoreCase(oldEventID+" Event has been removed.")) {
				...
				msg="Event not booked, so cant cancel";
			}
			return msg;
  ...
  public static void main(String[] args) throws IOException
   {
		...
		Tor_server ts=new Tor_server();
		Endpoint.publish("http://localhost:9010/tor", ts);   
